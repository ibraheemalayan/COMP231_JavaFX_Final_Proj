...
public interface MediaRentalInt {
     ...
     */
    boolean addToCart(String customerName,String mediaCode);
     ...
     */
    boolean removeFromCart(String customerName, String mediaCode);
     ...
     * @return
     */
    boolean returnMedia(String customerName,String mediaCode);
